...
<link href="<c:url value = "/resources/fontend/css/style.css" />" rel="stylesheet" type="text/css" />
<script src="<c:url value = "/resources/fontend/js/js/jquery-1.4.2.min.js" />" type="text/javascript"></script>
<script src="<c:url value = "/resources/fontend/js/cufon-yui.js" />" type="text/javascript"></script>
